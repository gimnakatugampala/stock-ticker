...
import {getlatestNews ,getQueryNews,TrendingTickerAPI ,MoversAPI ,autocompleteAPI,SummaryStockAPi,HoldersStockAPI,AnalysisStockAPI,FinancialStockAPI,ProfileStockAPI} from './api'
...
const App = () => {
    ...
    return (
        <div>
            ...
            {
                search !== '' ? <SingleStock ProfileStockAPI={ProfileStockAPI} FinancialStockAPI={FinancialStockAPI} AnalysisStockAPI={AnalysisStockAPI} SummaryStockAPi={SummaryStockAPi} HoldersStockAPI={HoldersStockAPI} symbol={symbol}  /> : (
                    <div className="row">
